...
<section class="body">
	...
	<table>
		...
		<tr>
			<td>이름</td>
			<td><input type="text" id="buyer_name" name="buyer_name" value="${mbDto.mname }" required="required"></td>
		</tr>
		<tr>
			<td>연락처</td>
			<td><input type="tel"  id="buyer_tel" name="buyer_tel" value="${mbDto.tel }" required="required"></td>
		</tr>
		<tr>
			<td>주소</td>
			<td><input type="text" id="buyer_addr" name="buyer_addr"  value="${mbDto.addr }" required="required"></td>
		</tr>
		<tr>
			<td>이메일</td>
			<td><input type="text" id="buyer_email" name="buyer_email" value="${resvDto.memberId }" required="required"></td>
		</tr>
		<tr>
			<td>포인트</td>
			<td>${mbDto.mpoint }</td>
			<td><input type="number" value="${mbDto.mpoint }" id="mPoint" name="mpoint" max="${mbDto.mpoint }"></td>
			<td><input type="button" value="포인트 사용" onclick="usePoint()"></td>		
		</tr>
	</table>
	<table>
	...
	<table>
		...
		<tr>	
			<td>할인금액</td>
			<td><input type="number" value="0" name="usePoint" id="discount" readonly="readonly">원</td>
		</tr>
		<tr>
			<td>결제금액</td>
			<td><input type="text" id="amount" value= "${resvDto.amount }" readonly="readonly"></td>
		</tr>
	</table>
	<table>
		<tr>
		...
		<tr>
			<td><input type="radio" name="pay_method" value="card">신용카드</td>
			<td><input type="radio" name="pay_method" value="vbank">무통장입금</td>
			<td><input type="radio" name="pay_method" value="trans">실시간계좌이체</td>
			<td><input type="radio" name="pay_method" value="phone">핸드폰 소액결제</td>
		</tr>
	</table>	
	<div>
